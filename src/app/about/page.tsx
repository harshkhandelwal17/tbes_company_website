      ...
      <section className="py-16 lg:py-32 bg-[#05080F] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Lusail City */}
            <div className="group relative rounded-3xl overflow-hidden aspect-video lg:aspect-[16/9]">
              <img src="/lusail-city.png" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-60" alt="Lusail City" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#05080F] via-transparent to-transparent"></div>
              <div className="absolute bottom-8 left-8">
            ...
            <div className="group relative rounded-3xl overflow-hidden aspect-video lg:aspect-[16/9]">
              <img src="/elizabeth-airport.png" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-60" alt="Elizabeth Airport" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#05080F] via-transparent to-transparent"></div>
              <div className="absolute bottom-8 left-8">
                <h4 className="text-2xl font-bold mb-2">Elizabeth Airport</h4>
                <p className="text-slate-400 text-sm max-w-xs">Full BIM modeling and coordination services for airport infrastructure development.</p>
              </div>
            </div>
