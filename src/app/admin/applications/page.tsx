              ...
              <div>
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex-1 flex items-center gap-3 p-4 rounded-xl bg-blue-600/10 border border-blue-500/20 hover:bg-blue-600/20 hover:border-blue-500/40 transition-all group"
                  >
                    <div className="p-2 bg-blue-500 rounded-lg text-white">
                      <FileText size={18} />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-blue-100">View Resume</p>
                      <p className="text-xs text-blue-300">Opens in new tab</p>
                    </div>
                    <ExternalLink size={16} className="text-blue-400 ml-auto group-hover:text-white transition-colors" />
                  </a>
                  <a
                    href={selectedApp.resumeUrl}
                    download="Applicant_Resume"
                    className="p-4 rounded-xl bg-zinc-800 border border-white/10 hover:bg-zinc-700 transition-all flex flex-col items-center justify-center gap-1 text-zinc-400 hover:text-white"
