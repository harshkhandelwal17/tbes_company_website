        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-2/5 space-y-6 text-center lg:text-left">
            ...
            <p className="text-slate-400 text-sm lg:text-base max-w-md mx-auto lg:mx-0 leading-relaxed">
              We eliminate construction uncertainties using intelligent 3D models. Our process ensures that your vision is built exactly as designed, within budget.
            </p>
            ...
            <div className="hidden lg:flex items-center gap-6 pt-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-500 uppercase font-bold">Global Clients</span>
              </div>
            </div>
          </div>
