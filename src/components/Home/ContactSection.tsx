...
import { Mail, Phone, MapPin, Send, CheckCircle2, ArrowRight, AlertCircle, Loader2, LocationEdit,
  Box, GitMerge, ScanLine, Monitor, PenTool, GraduationCap, MessageSquare, Check
} from 'lucide-react';
              ...
              <div className="bg-[#0D121F] rounded-[2.4rem] p-8 md:p-12 shadow-2xl overflow-hidden relative">
                ...
                {status === 'success' ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {/* Service Needed — icon card grid */}
                    <div className="space-y-1.5">
                      <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest pl-1">
                        Service Needed
                        <span className="ml-1.5 normal-case font-normal text-slate-600">— select all that apply</span>
                      </label>
