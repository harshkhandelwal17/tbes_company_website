...
import { getYearsOfExperience } from '@/lib/companyStats';
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-video lg:aspect-square group">
              ...
              <div className="absolute bottom-4 left-4 right-4 p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl hidden sm:flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">{companyYears}+</div>
                <div>
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              {[
                ...
                { icon: Target, title: "Multi-Trade", desc: "MEP, Structural, Arch" },
                { icon: Users, title: "Scalable", desc: "Small to mega projects" }
              ].map((item, idx) => (
